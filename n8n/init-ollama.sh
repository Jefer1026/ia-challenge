...
if ollama list | grep -q "llama3.1:8b-instruct-q4_K_M"; then
    echo "✅ El modelo llama3.1:8b-instruct-q4_K_M ya está disponible localmente."
else
    echo "⏳ Descargando modelo llama3.1:8b-instruct-q4_K_M(esto puede tardar unos minutos)..."
